 ...
 * @param {number} handle
 */
function vault_free(handle) {
    wasm.vault_free(handle);
}
exports.vault_free = vault_free;
 ...
 * @returns {Uint8Array}
 */
function vault_open_sealed(handle, blob) {
    const ptr0 = passArray8ToWasm0(blob, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.vault_open_sealed(handle, ptr0, len0);
    if (ret[3]) {
...
exports.vault_open_sealed = vault_open_sealed;
 ...
 * @returns {Uint8Array}
 */
function vault_seal(handle, plaintext) {
    const ptr0 = passArray8ToWasm0(plaintext, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.vault_seal(handle, ptr0, len0);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v2 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {number}
 */
function vault_unlock(passphrase) {
    const ptr0 = passArray8ToWasm0(passphrase, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.vault_unlock(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
}
exports.vault_unlock = vault_unlock;
...
const wasmPath = `${__dirname}/ghostvault_bg.wasm`;
